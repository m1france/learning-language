...
const fr: AppCopy = {
  ...
  welcome: 'Bienvenue', darkMode: 'Mode sombre', collapseSidebar: 'Réduire la barre latérale', expandSidebar: 'Agrandir la barre latérale', lightMode: 'Mode clair', roleLabel: 'Apprenant au quotidien', home: 'Accueil', reading: 'Lire', speaking: 'Parler', writing: 'Écrire', listening: 'Écouter', settings: 'Paramètres',
...
const en: AppCopy = {
  ...
  welcome: 'Welcome', darkMode: 'Dark mode', collapseSidebar: 'Collapse sidebar', expandSidebar: 'Expand sidebar', lightMode: 'Light mode', roleLabel: 'Everyday learner', home: 'Home', reading: 'Read', speaking: 'Speak', writing: 'Write', listening: 'Listen', settings: 'Settings',
...
const es: AppCopy = {
  ...
  welcome: 'Bienvenido', darkMode: 'Modo oscuro', collapseSidebar: 'Reducir la barra lateral', expandSidebar: 'Ampliar la barra lateral', lightMode: 'Modo claro', roleLabel: 'Aprendiz cotidiano', home: 'Inicio', reading: 'Leer', speaking: 'Hablar', writing: 'Escribir', listening: 'Escuchar', settings: 'Ajustes',
...
const zh: AppCopy = {
  ...
  welcome: '欢迎', darkMode: '深色模式', collapseSidebar: '收起侧边栏', expandSidebar: '展开侧边栏', lightMode: '浅色模式', roleLabel: '日常学习者', home: '首页', reading: '阅读', speaking: '口语', writing: '写作', listening: '听力', settings: '设置',
...
const ru: AppCopy = {
  ...
  welcome: 'Добро пожаловать', darkMode: 'Тёмная тема', collapseSidebar: 'Свернуть панель', expandSidebar: 'Развернуть панель', lightMode: 'Светлая тема', roleLabel: 'Учусь каждый день', home: 'Главная', reading: 'Читать', speaking: 'Говорить', writing: 'Писать', listening: 'Слушать', settings: 'Настройки',
...
const pt: AppCopy = {
  ...
  welcome: 'Bem-vindo', darkMode: 'Modo escuro', collapseSidebar: 'Recolher a barra lateral', expandSidebar: 'Expandir a barra lateral', lightMode: 'Modo claro', roleLabel: 'Aprendiz do dia a dia', home: 'Início', reading: 'Ler', speaking: 'Falar', writing: 'Escrever', listening: 'Ouvir', settings: 'Definições',
