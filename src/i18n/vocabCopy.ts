...
export type VocabCopy = {
  ...
  save: string
  cancel: string
  cancelAndDeleteAllWords: string
  selectionMode: string
  batchDeleteConfirm: (count: number) => string
  batchDeleteTitle: (count: number) => string
  batchEditTagsTitle: (count: number) => string
  batchEditLevelTitle: (count: number) => string
  batchEditTagsModalTitle: string
  batchEditLevelModalTitle: string
  apply: string
  replaceTagsMode: string
  addTagsMode: string
...
const frVocab: VocabCopy = {
  ...
  pronunciationField: 'Prononciation',
  ...
  save: 'Enregistrer',
  cancel: 'Annuler',
  cancelAndDeleteAllWords: 'Annuler et supprimer tous les mots enregistrés',
  selectionMode: 'Activer / désactiver la sélection multiple',
  batchDeleteConfirm: (count: number) => `Supprimer définitivement les ${count} mots sélectionnés ?`,
  batchDeleteTitle: (count: number) => `Supprimer les ${count} mots sélectionnés`,
  batchEditTagsTitle: (count: number) => `Modifier les tags des ${count} mots sélectionnés`,
  batchEditLevelTitle: (count: number) => `Modifier le niveau des ${count} mots sélectionnés`,
  batchEditTagsModalTitle: 'Modifier les tags des mots sélectionnés',
  batchEditLevelModalTitle: 'Modifier le niveau de maîtrise',
  apply: 'Appliquer',
  replaceTagsMode: 'Remplacer tous les tags',
  addTagsMode: 'Ajouter aux tags existants',
...
const enVocab: VocabCopy = {
  ...
  save: 'Save',
  cancel: 'Cancel',
  cancelAndDeleteAllWords: 'Cancel and delete all saved words',
  selectionMode: 'Toggle multi-selection mode',
  batchDeleteConfirm: (count: number) => `Permanently delete the ${count} selected words?`,
  batchDeleteTitle: (count: number) => `Delete ${count} selected words`,
  batchEditTagsTitle: (count: number) => `Edit tags for ${count} selected words`,
  batchEditLevelTitle: (count: number) => `Edit level for ${count} selected words`,
  batchEditTagsModalTitle: 'Edit tags for selected words',
  batchEditLevelModalTitle: 'Edit mastery level',
  apply: 'Apply',
  replaceTagsMode: 'Replace all tags',
...
const esVocab: VocabCopy = {
  ...
  pronunciationField: 'Pronunciación',
  ...
  save: 'Guardar',
  cancel: 'Cancelar',
  cancelAndDeleteAllWords: 'Cancelar y eliminar todas las palabras guardadas',
  selectionMode: 'Activar / desactivar selección múltiple',
  batchDeleteConfirm: (count: number) => `¿Eliminar definitivamente las ${count} palabras seleccionadas?`,
  batchDeleteTitle: (count: number) => `Eliminar las ${count} palabras seleccionadas`,
  batchEditTagsTitle: (count: number) => `Modificar etiquetas de las ${count} palabras`,
  batchEditLevelTitle: (count: number) => `Modificar nivel de las ${count} palabras`,
  batchEditTagsModalTitle: 'Modificar etiquetas de las palabras seleccionadas',
  batchEditLevelModalTitle: 'Modificar nivel de dominio',
  apply: 'Aplicar',
  replaceTagsMode: 'Reemplazar todas las etiquetas',
  addTagsMode: 'Añadir a etiquetas existentes',
...
const zhVocab: VocabCopy = {
  ...
  save: '保存',
  cancel: '取消',
  cancelAndDeleteAllWords: '取消并删除所有已保存的词汇',
  selectionMode: '开启/关闭多选模式',
  batchDeleteConfirm: (count: number) => `确定永久删除选中的 ${count} 个词汇吗？`,
  batchDeleteTitle: (count: number) => `删除选中的 ${count} 个词汇`,
  batchEditTagsTitle: (count: number) => `批量修改选中的 ${count} 个词汇标签`,
  batchEditLevelTitle: (count: number) => `批量修改选中的 ${count} 个词汇熟练度`,
  batchEditTagsModalTitle: '批量修改标签',
  batchEditLevelModalTitle: '批量修改熟练度',
  apply: '应用',
  replaceTagsMode: '替换全部标签',
  addTagsMode: '追加到现有标签',
...
const ruVocab: VocabCopy = {
  ...
  pronunciationField: 'Произношение',
  ...
  save: 'Сохранить',
  cancel: 'Отмена',
  cancelAndDeleteAllWords: 'Отменить и удалить все сохранённые слова',
  selectionMode: 'Включить / выключить множественный выбор',
  batchDeleteConfirm: (count: number) => `Окончательно удалить выбранные ${count} слов?`,
  batchDeleteTitle: (count: number) => `Удалить ${count} выбранных слов`,
  batchEditTagsTitle: (count: number) => `Изменить теги ${count} выбранных слов`,
  batchEditLevelTitle: (count: number) => `Изменить уровень освоения ${count} слов`,
  batchEditTagsModalTitle: 'Изменить теги выбранных слов',
  batchEditLevelModalTitle: 'Изменить уровень владения',
  apply: 'Применить',
  replaceTagsMode: 'Заменить все теги',
  addTagsMode: 'Добавить к существующим тегам',
...
const ptVocab: VocabCopy = {
  ...
  save: 'Guardar',
  cancel: 'Cancelar',
  cancelAndDeleteAllWords: 'Cancelar e eliminar todas as palavras guardadas',
  selectionMode: 'Ativar / desativar seleção múltipla',
  batchDeleteConfirm: (count: number) => `Eliminar definitivamente as ${count} palavras selecionadas?`,
  batchDeleteTitle: (count: number) => `Eliminar as ${count} palavras selecionadas`,
  batchEditTagsTitle: (count: number) => `Modificar etiquetas das ${count} palavras`,
  batchEditLevelTitle: (count: number) => `Modificar nível das ${count} palavras`,
  batchEditTagsModalTitle: 'Modificar etiquetas das palavras selecionadas',
  batchEditLevelModalTitle: 'Modificar nível de domínio',
  apply: 'Aplicar',
  replaceTagsMode: 'Substituir todas as etiquetas',
  addTagsMode: 'Adicionar às etiquetas existentes',
